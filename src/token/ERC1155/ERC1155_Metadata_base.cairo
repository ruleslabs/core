...
func ERC1155_Metadata_token_uri{
    syscall_ptr: felt*,
...
func _ERC1155_Metadata_base_token_uri{
  ...
  _ERC1155_Metadata_base_token_uri(base_token_uri_len = base_token_uri_len - 1, base_token_uri = base_token_uri + 1)
  return ()
end
...
func _ERC1155_Metadata_set_base_token_uri{
  ...
  _ERC1155_Metadata_set_base_token_uri(base_token_uri_len = base_token_uri_len - 1, base_token_uri = base_token_uri + 1)
  return ()
end
