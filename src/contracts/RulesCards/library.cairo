...
func RulesCards_card_model_available_supply{
    syscall_ptr: felt*,
    pedersen_ptr: HashBuiltin*,
    range_check_ptr
...
func RulesCards_create_card{
  ...
  let (available_supply) = RulesCards_card_model_available_supply(card_model=card.model)
